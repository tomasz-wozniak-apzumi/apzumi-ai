...
## Clarifying Scope Before Creating

Always ask the user about command scope if they haven't specified it. Do not assume global or project-level placement.

Only proceed with file creation after the user confirms the target location.

---
description: "Guidelines for creating high-quality custom instruction files for OpenCode. Use when writing new or updating existing instructions."
---
...
- Target audience: Developers and OpenCode working with domain-specific code
- File format: Markdown with YAML frontmatter
- File naming convention: lowercase with hyphens (e.g., `angular-best-practices.instructions.md`)
- Location: `.opencode/instructions/` directory
...
1. **Test with OpenCode**: Try the instructions with actual prompts to see if they guide the model as intended
